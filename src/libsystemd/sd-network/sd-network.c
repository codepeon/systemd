...
_public_ int sd_network_get_ipv4_address_state(const char *network_namespace, char **state) {
        return network_get_string("IPV4_ADDRESS_STATE", network_namespace, state);
}

_public_ int sd_network_get_ipv6_address_state(const char *network_namespace, char **state) {
        return network_get_string("IPV6_ADDRESS_STATE", network_namespace, state);
}

_public_ int sd_network_get_online_state(const char *network_namespace, char **state) {
...
_public_ int sd_network_link_get_required_family_for_online(int ifindex, const char *network_namespace, char **state) {
...
_public_ int sd_network_link_get_ipv4_address_state(int ifindex, const char *network_namespace, char **state) {
        return network_link_get_string(ifindex, "IPV4_ADDRESS_STATE", network_namespace, state);
}

_public_ int sd_network_link_get_ipv6_address_state(int ifindex, const char *network_namespace, char **state) {
        return network_link_get_string(ifindex, "IPV6_ADDRESS_STATE", network_namespace, state);
}

_public_ int sd_network_link_get_online_state(int ifindex, const char *network_namespace, char **state) {
        return network_link_get_string(ifindex, "ONLINE_STATE", network_namespace, state);
}

_public_ int sd_network_link_get_dhcp6_client_iaid_string(int ifindex, const char *network_namespace, char **iaid) {
        return network_link_get_string(ifindex, "DHCP6_CLIENT_IAID", network_namespace, iaid);
}

_public_ int sd_network_link_get_dhcp6_client_duid_string(int ifindex, const char *network_namespace, char **duid) {
...
_public_ int sd_network_link_get_activation_policy(int ifindex, const char *network_namespace, char **policy) {
        _cleanup_free_ char *s = NULL;
        int r;
...
_public_ int sd_network_link_get_sip(int ifindex, const char *network_namespace, char ***ret) {
